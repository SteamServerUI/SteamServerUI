...
func GetRunfileGallery(forceUpdate bool) ([]GalleryRunfile, error) {
	...
	const manifestURL = "https://jacksonthemaster.github.io/StationeersServerUI/gallery/runfiles/manifest.ssui"
	...
	currentVersion := config.GetBackendVersion()
...
func SaveRunfileToDisk(identifier string) error {
	...
	baseURL := "https://jacksonthemaster.github.io/StationeersServerUI/gallery/runfiles"
