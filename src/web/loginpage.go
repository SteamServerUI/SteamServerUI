...
func ServeLoginTemplate(w http.ResponseWriter, r *http.Request) {
	...
	steps := map[string]Step{
		...
		"discord_enabled": {
			...
			StepMessage:         "Do you want to enable Discord integration? Enter 'yes' to enable or 'no' to disable.",
		...
		"network_config_choice": {
			...
			StepMessage:         "Do you want to configure network settings? Enter 'yes' to configure or 'no' to use defaults. Note: Network configuration is especially important on Linux servers.",
			UsernamePlaceholder: "yes/no",
		...
		"server_visible": {
			...
			StepMessage:         "Make server visible in public listings? Enter 'yes' to make visible or 'no' to hide.",
			UsernamePlaceholder: "yes/no",
